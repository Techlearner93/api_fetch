## This simple react app's objective is to learn how to fetch data from an API, learn the basic concepts of async, await, promises and mapping the response out into a visual UI.
